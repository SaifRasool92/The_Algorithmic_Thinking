...
| --- | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| 1   | [Big O Notation](https://github.com/SaifRasool92/The_Algorithmic_Thinking/blob/main/1.Big%20O%20Notation.ipynb) | Learn how to analyze time and space complexity to evaluate algorithm efficiency.                                  |
| 2   | [Data Structures](https://github.com/SaifRasool92/The_Algorithmic_Thinking/blob/main/2.Data%20Structures.ipynb) | Explore common data structures (arrays, stacks, queues, linked lists) and their role in algorithm design.         |
| 3   | [Logarithms](https://github.com/SaifRasool92/The_Algorithmic_Thinking/blob/main/3.Logaritms.ipynb)              | Understand logarithmic growth, complexity, and their applications in searching and divide-and-conquer algorithms. |
